...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { description: @statistic.description, name: @statistic.name } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { description: @statistic.description, name: @statistic.name } }
