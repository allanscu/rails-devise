  ...
  class LinkRenderer < WillPaginate::ActionView::LinkRenderer
    ...
    def gap
      tag :li, tag(
          ...
          'data-toggle'=> 'popover',
          'data-placement'=> 'top',
          'data-content' => '<form method="get" accept-charset="UTF-8" action="" class="m-w-150">
  ...
  class LinkRendererAjax < WillPaginate::ActionView::LinkRenderer
    ...
    def gap
      tag :li, tag('span', '&hellip;',
                   ...
                   'data-toggle'=> 'popover',
                   'data-placement'=> 'top',
                   'data-content' => '<form method="get" data-remote="true" accept-charset="UTF-8" action="" class="m-w-150">
                      <input type="hidden" value="✓" name="utf8">
